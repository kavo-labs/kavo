...
- `search[fields]=<comma-list>` narrows the search to a subset of the entity's `search.fields` allowlist for this request. A name outside that allowlist is a 400.
