...
| `features/soft-delete.md`                                 | `getting-started.md` §Soft delete (walkthrough)                             | move; `configuration/settings.md` §delete stays under Guides/Configuration/Settings, cross-linked both ways                              |
...
| `features/allowed-and-computed-fields.md`                 | `configuration/entity-config.md` §allowed + §computed (moved)               | move; `using-the-api.md` §Computed fields (caller-facing usage) is prepended to this page as its own subsection                          |
...
| `guides/configuration/settings.md`                        | `integrations/nest/configuration/settings.md`                               | move (content unchanged; still holds §relations/§delete/§realtime/§caching alongside the new Features pages — cross-linked, not deleted) |
| `guides/configuration/entity-config.md`                   | `integrations/nest/configuration/entity-config.md` minus §allowed/§computed | move + split                                                                                                                             |
