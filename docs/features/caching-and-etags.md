...
Both halves are one setting, [`caching.etag`](/guides/configuration/settings#caching) (on by default). Turning it off at any scope stops the tags being generated _and_ stops the conditional headers being honored.
