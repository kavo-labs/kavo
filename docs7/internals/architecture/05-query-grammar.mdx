---
title: "05 — Query Model, Filter Engine & Query String Grammar"
---

{/* Generated from docs/internals/architecture/05-query-grammar.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
