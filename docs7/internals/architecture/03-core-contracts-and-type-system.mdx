---
title: "03 — Core Contracts & Type System"
---

{/* Generated from docs/internals/architecture/03-core-contracts-and-type-system.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
