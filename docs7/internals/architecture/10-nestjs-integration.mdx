---
title: "10 — NestJS Integration"
---

{/* Generated from docs/internals/architecture/10-nestjs-integration.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
