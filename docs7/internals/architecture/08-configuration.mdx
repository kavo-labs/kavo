---
title: "08 — Configuration System"
---

{/* Generated from docs/internals/architecture/08-configuration.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
