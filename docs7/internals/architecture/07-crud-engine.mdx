---
title: "07 — CRUD Engine"
---

{/* Generated from docs/internals/architecture/07-crud-engine.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
...
[doc 01 §6](/internals/architecture/01-system-architecture#6-design-patterns-and-why).
