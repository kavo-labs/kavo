---
title: "12 — Relation System & Nested Includes"
---

{/* Generated from docs/internals/architecture/12-relations-and-includes.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
