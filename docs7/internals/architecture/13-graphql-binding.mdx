---
title: "13 — GraphQL Binding"
---

{/* Generated from docs/internals/architecture/13-graphql-binding.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
