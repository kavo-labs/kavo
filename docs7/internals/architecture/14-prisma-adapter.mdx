---
title: "14 — Prisma Adapter"
---

{/* Generated from docs/internals/architecture/14-prisma-adapter.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
