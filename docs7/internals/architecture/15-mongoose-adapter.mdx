---
title: "15 — Mongoose Adapter"
---

{/* Generated from docs/internals/architecture/15-mongoose-adapter.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
