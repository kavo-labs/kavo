---
title: "09 — TypeORM Adapter"
---

{/* Generated from docs/internals/architecture/09-typeorm-adapter.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
