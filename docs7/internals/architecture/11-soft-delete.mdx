---
title: "11 — Soft Delete, Restore & Purge"
---

{/* Generated from docs/internals/architecture/11-soft-delete.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
