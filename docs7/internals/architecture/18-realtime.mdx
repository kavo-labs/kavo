---
title: "18 — Realtime Events, Channels & Subscription Filtering"
---

{/* Generated from docs/internals/architecture/18-realtime.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
