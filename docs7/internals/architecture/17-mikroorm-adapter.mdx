---
title: "17 — MikroORM Adapter"
---

{/* Generated from docs/internals/architecture/17-mikroorm-adapter.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
