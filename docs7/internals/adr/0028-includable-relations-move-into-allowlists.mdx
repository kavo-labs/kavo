---
title: "ADR-0028 — Relation inclusion permission moves into allowed.includable"
---

{/* Generated from docs/internals/adr/0028-includable-relations-move-into-allowlists.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
