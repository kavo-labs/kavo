---
title: "ADR-0027 — An @Override inherits the ETag, but not the precondition"
---

{/* Generated from docs/internals/adr/0027-an-override-inherits-the-etag-but-not-the-precondition.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
