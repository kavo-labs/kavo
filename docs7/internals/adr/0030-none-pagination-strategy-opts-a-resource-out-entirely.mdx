---
title: "ADR-0030 — pagination.strategy: \"none\" opts a resource out of pagination entirely"
---

{/* Generated from docs/internals/adr/0030-none-pagination-strategy-opts-a-resource-out-entirely.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
