---
title: "ADR-0021 — Pagination becomes a union, and a cursor is opaque rather than signed"
---

{/* Generated from docs/internals/adr/0021-cursor-pagination-is-an-opaque-keyset-union.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
