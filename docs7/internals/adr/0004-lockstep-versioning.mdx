---
title: "ADR-0004 — Lockstep versioning"
---

{/* Generated from docs/internals/adr/0004-lockstep-versioning.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
