---
title: "ADR-0031 — The result cache is a live per-entity store, invalidated wholesale on writes"
---

{/* Generated from docs/internals/adr/0031-result-cache-is-a-live-store-invalidated-wholesale.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
