---
title: "ADR-0022 — since pagination composes a value|id keyset, forced sort, plain token"
---

{/* Generated from docs/internals/adr/0022-since-pagination-composes-a-value-id-keyset.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
