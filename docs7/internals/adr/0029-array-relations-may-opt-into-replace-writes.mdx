---
title: "ADR-0029 — Array relations may opt into replace writes, config-declared per relation"
---

{/* Generated from docs/internals/adr/0029-array-relations-may-opt-into-replace-writes.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
