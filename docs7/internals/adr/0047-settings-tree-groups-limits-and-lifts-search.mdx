---
title: "ADR-0047 — KavoSettings groups request-cost ceilings under limits and lifts search to top level"
---

{/* Generated from docs/internals/adr/0047-settings-tree-groups-limits-and-lifts-search.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
