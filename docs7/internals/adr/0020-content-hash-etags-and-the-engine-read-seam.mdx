---
title: "ADR-0020 — ETags are content hashes of the representation, and preconditions are evaluated by the engine through its own reader"
---

{/* Generated from docs/internals/adr/0020-content-hash-etags-and-the-engine-read-seam.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
