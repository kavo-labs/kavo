---
title: "ADR-0050 — Derived fields come from ORM metadata; core stays expression-agnostic"
---

{/* Generated from docs/internals/adr/0050-derived-fields-come-from-orm-metadata.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}

**Status:** accepted — supersedes [ADR-0019](/internals/adr/0019-computed-fields-are-serializer-evaluated).
