---
title: "ADR-0052 — identifier config key retargets the lookup axis only"
---

{/* Generated from docs/internals/adr/0052-identifier-config-key-is-lookup-axis-only.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
