---
title: "ADR-0015 — Global operation defaults are enforced by the engine, not decoration-time routing"
---

{/* Generated from docs/internals/adr/0015-global-operation-defaults-are-engine-only.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
