---
title: "ADR-0025 — Handlers reach persistence through the request context"
---

{/* Generated from docs/internals/adr/0025-handlers-reach-persistence-through-the-context.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
