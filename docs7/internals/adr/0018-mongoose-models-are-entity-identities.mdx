---
title: "ADR-0018 — A Mongoose model is the entity identity, and ObjectId converts at the adapter boundary"
---

{/* Generated from docs/internals/adr/0018-mongoose-models-are-entity-identities.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
