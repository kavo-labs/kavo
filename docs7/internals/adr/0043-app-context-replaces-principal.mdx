---
title: "ADR-0043 — KavoContext.app (an app-defined context) replaces principal"
---

{/* Generated from docs/internals/adr/0043-app-context-replaces-principal.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
