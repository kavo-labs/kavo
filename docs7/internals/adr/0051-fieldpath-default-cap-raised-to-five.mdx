---
title: "ADR-0051 — FieldPath's default recursion cap is raised from 3 to 5"
---

{/* Generated from docs/internals/adr/0051-fieldpath-default-cap-raised-to-five.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
