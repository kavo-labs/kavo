---
title: "ADR-0014 — Write-side relations: associate by id, no deep nested writes"
---

{/* Generated from docs/internals/adr/0014-associate-by-id-not-deep-writes.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
