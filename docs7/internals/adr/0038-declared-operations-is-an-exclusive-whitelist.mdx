---
title: "ADR-0038 — Declaring operations at all makes it an exclusive whitelist"
---

{/* Generated from docs/internals/adr/0038-declared-operations-is-an-exclusive-whitelist.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
