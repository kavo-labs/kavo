---
title: "ADR-0041 — Releases are cut by release-please"
---

{/* Generated from docs/internals/adr/0041-releases-are-cut-by-release-please.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
