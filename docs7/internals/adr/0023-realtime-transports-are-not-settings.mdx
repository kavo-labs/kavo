---
title: "ADR-0023 — Realtime transports are resolved config, not settings-tree data"
---

{/* Generated from docs/internals/adr/0023-realtime-transports-are-not-settings.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
