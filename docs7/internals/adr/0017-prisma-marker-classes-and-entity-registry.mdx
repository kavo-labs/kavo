---
title: "ADR-0017 — Prisma marker classes and the explicit entity registry"
---

{/* Generated from docs/internals/adr/0017-prisma-marker-classes-and-entity-registry.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
