---
title: "ADR-0049 — set forces write-body values"
---

{/* Generated from docs/internals/adr/0049-write-apply-forces-create-update-body-values.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
