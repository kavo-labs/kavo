---
title: "ADR-0048 — apply adds an unconditional, per-axis server-side query constraint"
---

{/* Generated from docs/internals/adr/0048-apply-server-side-query-constraint.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
