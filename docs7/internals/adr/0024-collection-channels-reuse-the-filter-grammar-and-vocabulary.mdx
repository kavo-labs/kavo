---
title: "ADR-0024 — Collection-level realtime subscriptions reuse the entity name as their channel and the REST filter grammar/vocabulary for scoping"
---

{/* Generated from docs/internals/adr/0024-collection-channels-reuse-the-filter-grammar-and-vocabulary.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
