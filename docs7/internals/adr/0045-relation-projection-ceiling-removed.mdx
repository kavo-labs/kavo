---
title: "ADR-0045 — allowed.selectable takes root paths only"
---

{/* Generated from docs/internals/adr/0045-relation-projection-ceiling-removed.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
