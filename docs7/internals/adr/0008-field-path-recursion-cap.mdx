---
title: "ADR-0008 — FieldPath recursion cap (max 5)"
---

{/* Generated from docs/internals/adr/0008-field-path-recursion-cap.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
