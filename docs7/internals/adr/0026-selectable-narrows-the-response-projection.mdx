---
title: "ADR-0026 — allowed.selectable narrows the response, not only the request"
---

{/* Generated from docs/internals/adr/0026-selectable-narrows-the-response-projection.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
