---
title: "ADR-0042 — Filter and Query are documented-only aggregate component schemas"
---

{/* Generated from docs/internals/adr/0042-filter-and-query-component-schemas.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
