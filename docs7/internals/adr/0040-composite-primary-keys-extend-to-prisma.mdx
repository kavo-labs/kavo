---
title: "ADR-0040 — Composite primary keys extend to @kavo/prisma"
---

{/* Generated from docs/internals/adr/0040-composite-primary-keys-extend-to-prisma.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
