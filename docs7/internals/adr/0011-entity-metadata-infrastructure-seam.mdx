---
title: "ADR-0011 — Entity-metadata & infrastructure seam"
---

{/* Generated from docs/internals/adr/0011-entity-metadata-infrastructure-seam.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
