---
title: "ADR-0039 — Composite primary keys, @kavo/typeorm only"
---

{/* Generated from docs/internals/adr/0039-composite-primary-keys-are-typeorm-only.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
...
> **Scope update:** [ADR-0040](/internals/adr/0040-composite-primary-keys-extend-to-prisma) extends this to `@kavo/prisma` (issue #266). `@kavo/mongoose` and `@kavo/mikroorm` remain out of scope, undecided.
