---
title: "ADR-0012 — Decoration-time route generation in @kavo/nest"
---

{/* Generated from docs/internals/adr/0012-decoration-time-route-generation.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
