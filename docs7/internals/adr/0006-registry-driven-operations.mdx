---
title: "ADR-0006 — Registry-driven operation dispatch"
---

{/* Generated from docs/internals/adr/0006-registry-driven-operations.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
