---
title: "ADR-0046 — A defaults block covers what a request looks like when the client asks for nothing"
---

{/* Generated from docs/internals/adr/0046-defaults-block-for-omitted-query-axes.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
