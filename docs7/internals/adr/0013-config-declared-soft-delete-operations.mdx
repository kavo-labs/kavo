---
title: "ADR-0013 — Soft-delete operations are enabled from config, not ORM metadata"
---

{/* Generated from docs/internals/adr/0013-config-declared-soft-delete-operations.md by scripts/build-docs7.mjs. Edit that file, then run pnpm docs7:build. */}
